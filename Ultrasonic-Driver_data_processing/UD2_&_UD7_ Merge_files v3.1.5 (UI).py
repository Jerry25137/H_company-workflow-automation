...
class UD_App:
    def __init__(self, root):
        ...
        # 第一行的選項 --------------------------------------------------------------------------------------
        self.frame1 = ttk.LabelFrame(self.root, text = "UD驅動器數據資料：", relief = "groove", borderwidth = 2)
        ...
        # 掃頻設定 ---------------------------------------------------------------------------------------------
        self.scan_frame = ttk.LabelFrame(self.root, text = "           ", relief = "groove", borderwidth = 2)
